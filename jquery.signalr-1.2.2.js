...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies.notificationHub.server = {
            registerConnection: function (connectionId, accountNumber, notificationToken, licenseKey) {
                return proxies.notificationHub.invoke.apply(proxies.notificationHub, $.merge(["RegisterConnection"], $.makeArray(arguments)));
            },

            sendHeartbeat: function (accountNumber) {
                return proxies.notificationHub.invoke.apply(proxies.notificationHub, $.merge(["SendHeartbeat"], $.makeArray(arguments)));
            },

            setCustomerLevelMessageTypes: function (customerLevelMessageTypes) {
                return proxies.notificationHub.invoke.apply(proxies.notificationHub, $.merge(["SetCustomerLevelMessageTypes"], $.makeArray(arguments)));
            }
        };
